...
set _files=install.rdf *.manifest *.js *.jsm *.xul *.xml *.html *.css license* *.png defaults modules components locale chrome idl changelog*
if exist %_7zip% (
	echo =^> %_7zip%
