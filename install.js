...
var XpiInstaller = {
    ...
    extFullName: 'ArchView', // The name displayed to the user (don't include the version)
    extShortName: 'archview', // The leafname of the JAR file (without the .jar part)
    extVersion: '0.7.1',
    extAuthor: 'Solar Flare',
    extLocaleNames: ['de-DE', 'en-US', 'es-ES', 'ja-JP', 'nl-NL', 'pt-BR', 'ru-RU', 'zh-CN'],
    extSkinNames: ['classic'], // e.g. ['classic', 'modern']
    extPreferences : ['archview-prefs.js'], // e.g., ['extension.js']
    ...
    install: function()
    {
        ...
        else if (!this.silentInstall)
        {
            ...
            this.profileInstall = Install.confirm('Install ' + this.extFullName + ' ' + this.extVersion + ' to your Profile directory [OK] or the Browser directory [Cancel]?');
        }
        ...
        for (var pref in this.extPreferences)
        {
            ...
            Install.addFile(null, 'defaults/preferences/' + this.extPreferences[pref], prefFolder, null);
        }
